...
namespace Checkout.Web.Client
{
    ...
    public partial class ApiClient 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<ProductDto>> ProductsByCountryIdGetAsync(int countryId, int? pageIndex, int? pageSize, string version)
        {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<ProductDto>> ProductsByCountryIdGetAsync(int countryId, int? pageIndex, int? pageSize, string version, System.Threading.CancellationToken cancellationToken)
        {
            if (countryId == null)
                throw new System.ArgumentNullException("countryId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        return default(System.Collections.ObjectModel.ObservableCollection<ProductDto>);
                    }
                    finally
                    {
                        if (response_ != null)
